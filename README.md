...
- **SF Symbols Integration**: Browse the built-in collection or open Apple's SF Symbols app, copy any symbol name, and paste it into FolderIcon. Invalid names are detected before rendering.
...
2. **Choose Style**:
   ...
   - **Icon**: Choose an included SF Symbol, paste any valid SF Symbol name, select an Emoji, or upload a Custom image.
...
The tests cover the SF Symbols grid, default opacity, zero-opacity rendering, history pruning and deletion, and history state restoration.
